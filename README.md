...
Garage Ghost is **completely free** — no accounts, no sign-ups, no paywall. Every feature is
unlimited:

- Diagnoses, follow-up questions and DTC lookups — unlimited.
- Repair cost estimates — always shown (suppressed only for genuine emergencies).
- Print / Save-as-PDF reports — free for every result.

There is no Pro tier, no pricing page, and no payment processing anywhere in the app.
...
**Live: https://garage-ghost.vercel.app** — the app needs no environment variables or API keys.
